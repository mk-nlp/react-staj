...
const ResultPage = () => {
  ...
  const { thermalSensation, probabilityOfPrecipitation, windSpeed, airHumidity, UVIndex, dayStage, cityName, day, weatherInterpretation, dailyInterpretation, dailyMaxTemperature, dailyMinTemperature
  ...
  function useFourDaysAfterToday() {
    ...
    return [days[currentDay], days[nextDay1], days[nextDay2], days[nextDay3], days[nextDay4]]
  }
  ...
  return (
    <div>
      <div className="grid grid-cols-3 grid-rows-2 gap-2 p-2 md:grid-cols-5">
          <div className={`${bgClass} bg-cover bg-center grid col-span-3 row-span-1 p-2 rounded-2xl border-iwgray600 border-8 md:col-start-2`}>
            <div className="grid grid-cols-3 grid-rows-2 p-2">
              ...
              <div className="grid row-start-3 row-end-4 justify-items-center items-end">
                <div className="text-6xl font-extrabold">{Math.round(thermalSensation)}°C</div>
              </div>
              <div className="grid  col-start-2 col-end-4 row-start-3 row-end-5">
                <img className=' w-64 h-60 ml-8 lg:ml-24 xl:ml-44' src={currentIcon} alt="WeatherSitRepCloudyNight" />
              </div>
              <div className="grid grid-rows-1 col-start-1 row-start-4 row-end-5">
                <div className="grid text-xl font-sans font-bold items-end">{Math.round(dailyMinTemperature[0])}°C / {Math.round(dailyMaxTemperature[0])}°C</div>
        ...
        <div className="grid  col-span-3 rounded-2xl grid-cols-5 grid-rows-1 items-start bg-iwgray600 p-4 md:col-start-2">
          <div className=' grid col-start-1 col-end-2 items-center'>
            <div className="grid text-xl font-bold justify-center items-center">{fourDaysAfter[0].slice(0,3)}</div>
            <img className='grid w-96 h-50 justify-center' src={dailyIcons[0]} alt="WeatherSitRepCloudyNight" />
            <div className="grid font-bold font-sans justify-center">{Math.round(dailyMinTemperature[0])}°C</div>
            <div className="grid text-gray-500 font-bold font-sans justify-center">{Math.round(dailyMaxTemperature[0])}°C</div>
          </div>
          <div className=' grid col-start-2 col-end-3 items-center'>
            <div className="grid text-xl font-bold justify-center">{fourDaysAfter[1].slice(0,3)}</div>
            <img className='grid w-96  h-50 justify-center' src={dailyIcons[1]} alt="WeatherSitRepCloudyNight" />
            <div className="grid font-bold font-sans justify-center">{Math.round(dailyMinTemperature[1])}°C</div>
            <div className="grid text-gray-500 font-bold font-sans justify-center">{Math.round(dailyMaxTemperature[1])}°C</div>
          </div>
          <div className=' grid col-start-3 col-end-4 items-center'>
            <div className="grid text-xl font-bold justify-center">{fourDaysAfter[2].slice(0,3)}</div>
            <img className='grid w-96  h-50 justify-center' src={dailyIcons[2]} alt="WeatherSitRepCloudyNight" />
            <div className="grid font-bold font-sans justify-center">{Math.round(dailyMinTemperature[2])}°C</div>
            <div className="grid text-gray-500 font-bold font-sans justify-center">{Math.round(dailyMaxTemperature[2])}°C</div>
          </div>
          <div className=' grid col-start-4 col-end-5 items-center'>
            <div className="grid text-xl font-bold justify-center">{fourDaysAfter[3].slice(0,3)}</div>
            <img className='grid w-96  h-50 justify-center' src={dailyIcons[3]} alt="WeatherSitRepCloudyNight" />
            <div className="grid font-bold font-sans justify-center">{Math.round(dailyMinTemperature[3])}°C</div>
            <div className="grid text-gray-500 font-bold font-sans justify-center">{Math.round(dailyMaxTemperature[3])}°C</div>
          </div>
          <div className=' grid col-start-5 col-end-6 items-center'>
            <div className="grid text-xl font-bold justify-center">{fourDaysAfter[4].slice(0,3)}</div>
            <img className='grid w-96  h-50 justify-center' src={dailyIcons[4]} alt="WeatherSitRepCloudyNight" />
            <div className="grid font-bold font-sans justify-center">{Math.round(dailyMinTemperature[4])}°C</div>
            <div className="grid text-gray-500 font-bold font-sans justify-center">{Math.round(dailyMaxTemperature[4])}°C</div>
          </div>
        </div>
        </div>
        <div className='grid justify-center'>
          <Button className="flex items-center w-[300px] mt-5 mb-5 bg-iwgray600  font-bold" onClick={() => updateSearchSuccess(false)}>
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className=' bg-iwgray600'>
              <DialogHeader>
                <DialogTitle className=' font-bold text-center'>Forget about me</DialogTitle>
              </DialogHeader>
              <DialogDescription className=' text-iwgray300 font-bold text-center'>
               This action will clear all your previous searches.
              </DialogDescription>
              <div className="flex justify-end gap-2">
                <Button className="bg-red-900 font-bold" onClick={() => [updateSearchSuccess(false), clearLocalStorage(), setOpen(false)]}>Forget about me</Button>
                <Button className="bg-iwgray400 font-bold" onClick={() => setOpen(false)}>Cancel</Button>
              </div>
            </DialogContent>
            </Dialog>
          </div>
